...
import { CacheStrategy, IRGQLValue } from 'rgraphql'
...
export class ResultTree {
  ...
  constructor(private qtree: QueryTree, cacheStrategy: CacheStrategy, cacheSize: number) {
  ...
  public handleValue(val: IRGQLValue) {
